...
if (!isset($_SESSION['user']) || $_SESSION['role'] !== 'recruiter') {
    ...
    <main>
        ...
        <div class="dashboard-container">
            <div class="dashboard-links">
                ...
                <a href="manage-jobs.html" class="dashboard-btn">📝 Manage Jobs</a>
                <a href="search-candidates.html" class="dashboard-btn">🔎 Search Candidates</a>
                <a href="view-applications.html" class="dashboard-btn">📩 View Applications</a>
