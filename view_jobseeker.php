...
if (isset($_GET["id"]) && is_numeric($_GET["id"])) {
    $jobseeker_id = mysqli_real_escape_string($conn, $_GET["id"]);

    // Fetch the job seeker data based on the ID
    $sql_select = "SELECT * FROM job_seekers WHERE id = '$jobseeker_id'";
    $result_select = mysqli_query($conn, $sql_select);

    if (mysqli_num_rows($result_select) == 1) {
        $jobseeker = mysqli_fetch_assoc($result_select);
    } else {
        $message = "<div style='color: red;'>Error: Job seeker not found.</div>";
        $jobseeker_id = null; // Reset job seeker ID if not found
    }
} else {
    $message = "<div style='color: red;'>Error: Invalid job seeker ID.</div>";
}
...
<head>
    ...
    <title>View Job Seeker Details | Skillera Admin (India Edition)</title>
    ...
    <style>
        ...
        .jobseeker-details-container h3 {
            color: #58a6ff;
            margin-top: 0;
            margin-bottom: 15px;
        }
        ...
        .jobseeker-details-container strong {
            color: #c9d1d9;
            font-weight: bold;
        }
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="jobseeker_management.php" class="active">Job Seeker Management</a></li>
    ...
    <div class="content">
        ...
        <?php if ($jobseeker): ?>
            <div class="jobseeker-details-container">
                <h3>Job Seeker Information</h3>
                <p><strong>ID:</strong> <?php echo $jobseeker['id']; ?></p>
                ...
                <p><strong>Registration Date:</strong> <?php echo $jobseeker['registration_date']; ?></p>
                </div>
        <?php endif; ?>

        <p><a href="jobseeker_management.php" class="back-link">Back to Job Seeker Management</a></p>
